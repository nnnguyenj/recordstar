...
urlpatterns = [
    ...
    path("collection/<int:collection_id>/add-record/", views.add_record_to_collection, name="add_record_to_collection"),
    path("collection/<int:collection_id>/edit/", views.edit_collection_view, name="edit_collection"),
    path("collection/<int:collection_id>/delete/", views.delete_collection_view, name="delete_collection"),
    path("collection/<int:collection_id>/remove-record/<int:record_id>/", views.remove_record_from_collection, name="remove_record_from_collection"),
